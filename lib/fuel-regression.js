...
var IDLE_CLASS_TABLE = {
  // priorLph: starting industry estimate; boundsLph: hard physical clamps.
  // This table is the single human-reviewable input to the pooled model.
  pto_heavy:      { priorLph: 3.5, boundsLph: [1.5, 8.0] },  // crane / bucket / hydraulic PTO
  light_vehicle:  { priorLph: 1.0, boundsLph: [0.4, 2.0] },  // utes, cars
  standard_truck: { priorLph: 2.5, boundsLph: [1.0, 4.5] },  // default diesel truck
};
